...
public class DispatcherEmulatorController {
    ...
    public void initialize(String id, AppKickstarter appKickstarter, Logger log, DispatcherEmulator dispatcherEmulator) {
        ...
        this.dispatcherEmulatorMBox = appKickstarter.getThread("DispatcherEmulatorHandler").getMBox();
    }

    public void buttonPressed(ActionEvent actionEvent) {
        Button btn = (Button) actionEvent.getSource();
        String btnTxt = btn.getText();
        dispatcherEmulatorMBox.send(new Msg(id, dispatcherEmulatorMBox, Msg.Type.CDC_ButtonPressed, btnTxt));
    }
}
